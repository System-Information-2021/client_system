...
const Index = () => {
    ...
    return (
        <div className="form_login container">
            ...
            <div className="row">
                <div className={user ? "side_left col-12 col-md-5" : "side_left col-12 col-md-6"}>
                ...
                <div className={user ? "side_right col-12 col-md-7" : "side_right col-12 col-md-6"}>
                    {
                        user ? (<div className="list-group">
                            <button
                                type="button"
                            ...
                            <button type="button" className="list-group-item list-group-item-action">
                                Mobile Phone: {user.mobile_number || "not provided"}
                            </button>
                        </div>
                        ) : (<>
